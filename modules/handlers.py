...
PROBLEM_1_SOLUTION = """
Помещая одну за одной скрепки в сосуды, мы будем наблюдать появление водяного бугорка. 
Вода стремится принять сферическую форму благодаря силе поверхностного натяжения. 
Именно эта сила не даёт жидкости вытечь даже при том условии, что её объём больше объёма сосуда. 
Сила поверхностного натяжения пропорциональна длине контура, ограничивающего поверхность жидкости: чем больше контур, 
тем больше сила, поэтому чем шире сосуд, тем больший объем имеет выпуклость. 
Таким образом, можем сделать вывод, что в пиалу поместится больше скрепок, чем в стакан, до того, как начнёт выливаться вода.

Оценим количество скрепок в сосудах:
Будем считать, что максимально возможная высота бугорка 1 мм, и что он имеет цилиндрическую форму.
По формуле для цилиндра (V = πD²h/4) объём выпуклости составляет для пиалы около 7850 кубических мм, а для стакана - 1960 кубических мм. Тогда легко вычислить, что в пиалу поместится 7850/35⋍224 скрепки, а в стакан - 56, то есть в четыре раза меньше.
"""
